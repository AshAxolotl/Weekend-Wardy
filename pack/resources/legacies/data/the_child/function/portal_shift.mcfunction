...
$execute as @s at @s rotated as @s run portal euler make_portal ^ ^1.2 ^2 ~ ~180 2 0.01 1 {dimensionTo:"minecraft:overworld", destinationX:$(destX), destinationY:$(destY), destinationZ:$(destZ), CustomName:"OtherExit", interactable:0b, adjustPositionAfterTeleport:0b, animation:{curve:"circle",durationTicks:8}}
